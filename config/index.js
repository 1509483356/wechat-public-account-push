export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx90f55cb438d3119a",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "ff1c3dc191466c8aad96830fd7951b98",
  ...
  USERS: [
    {
      ...
      id: "oq5hU6AS2_tL8UNFtpoGS8-XZ-XE",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "今天也是元气满满的一天啦，快起床啦，永远爱你奥",
      // 所在省份
      province: "贵阳",
      // 所在城市
      city: "贵阳",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2001", "date": "09-26"},
        {"type": "节日", "name": "恋爱纪念日", "year": "2021", "date": "11-27"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "李四", "year": "2001", "date": "09-26"},
        {"type": "节日", "name": "被搭讪纪念日", "year": "2021", "date": "11-27"},
      ],
